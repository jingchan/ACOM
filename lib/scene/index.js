...
var Phaser = require('phaser'); //only used for math functions...
...
exports.prototype.addEntity = function(entity){
  ...
  entity.on('tryAttack', function(data) {
    var dist = Phaser.Math.distance(data.x1, data.y1,
                             data.x2, data.y2);
    Debug.log("DigitalLine of attack\n", self.map.digitalLine(
