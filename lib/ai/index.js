...
/* dumb AI for testing - it just sits there. */
exports.prototype.makeDumbAIAction = function(situation, done) {
  Debug.log("Actor is going to nap this turn.");
  this.actor.owner.emit("endTurn", null);
  done();
};
