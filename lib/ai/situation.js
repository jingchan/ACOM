...
function Situation(AI, scene) {
  // TODO: right now, probably just give the union of all the
  // visible tiles to the AI, as well as all entities on them.

  // TODO: eventually, when we render the game to the player, the
  //       renderer should really just render the Situation visible
  //       to the player, not the scene!!
