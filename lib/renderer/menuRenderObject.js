...
function MenuRenderObject(renderer, menu){
  ...
  var that = this;
    ...
    // only person that should shut it iff is the render function
    self.shouldRender = true;
		self.state = 'hiding';
	});
...
exports.prototype.render = function() {
  ...
  console.log("time to render!" + this.position.x + " " + this.position.y);
  console.log(this);
  this.bkSprite.reset(this.position.x, this.position.y);
