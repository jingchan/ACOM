...
exports.prototype.update = function(){
  if(this.dirty){
    ...
    //update position
    // TODO: Determine who should be responsible for updating the position
    var owner = this.visual.owner;
    var position = this.renderer._screenCoordFromGridCoord(owner.position.x, owner.position.y);
    if(this.visual.offset){
      position.x += this.visual.offset[0];
      position.y += this.visual.offset[1];
    }
