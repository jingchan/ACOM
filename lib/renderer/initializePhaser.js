...
function initializePhaser(renderer, viewx, viewy, tileSize, gameDiv, completionHandler) {
	...
	var mainState = {
      ...
      // for now.
			...
			game.load.image('movement_tiles', 'move_grid.png');
		},
      ...
      // fog of war should obscure entities
      renderer.fowLayer = game.add.group();

      // the top layer should be for things like menus and events
      // that take place in the "meta-game", and so should be above
