...
exports.prototype._addMapToStage = function (){
  ...
  tileMap.createBlankLayer('visibleLevel', map.width, map.height,
                                tileSize, tileSize,
                                this.display);
  tileMap.createBlankLayer('sightBlockingLevel', map.width, map.height,
                                tileSize, tileSize,
                                this.display);
  var that = this;
  ...
  map.eachTile(function(tile, i, j){
    ...
    var layerName = (tileType.options.blocksSight ? 'sightBlockingLevel' : 'visibleLevel');
    tileMap.putTile(tileIndex, i, j, layerName);
  });
};
