	...
	scene.on('entityAdded', function(entity){
      ...
      entity.on('successAttack', function(data) {
        ...
        if (data.renderKey === 'bunnyBullet') {
          ...
          Debug.log("go vanessa!");
          vanessa.reset(target.x - 120, target.y - 250);
          vanessa.animations.play('default', 7);
...
exports.prototype.initializeGame = function(viewx, viewy, tileSize, gameDiv) {
	...
	var mainState = {
      ...
      var vanessaFist = game.loadedSprites['vanessaFist'] = game.topLayer.create(0,0,'vanessa2');
