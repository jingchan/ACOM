...
exports.prototype.addRenderObject = function(renderObject){
	...
	Debug.log("Renderer adds", renderObject.name);
	this.renderObjects.push(renderObject);
  // this.game.entityLayer.add(renderObject.display);
  renderObject.display.position.x = 0;
  renderObject.display.position.y = 0;

};

exports.prototype.removeRenderObject = function(renderObject){
  // this.game.entityLayer.remove(renderObject.display);
	renderObject.renderer = null;
