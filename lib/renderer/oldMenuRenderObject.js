...
function MenuRenderObject(renderer, menu){
  ...
  this.display = game.add.group(game.entityLayer);
...
exports.prototype._generateHoverMenu = function(){
  ...
  this.itemDisplay = game.add.group(this.display);
  this.items = [];
  var self = this;
  ...
  // [[ Background ]]
  var backingDisplay = game.add.graphics(0, 0, this.display);
  ...
  var selectionDisplay = game.add.text(0, 0, '>', self.fontStyle, this.display);
