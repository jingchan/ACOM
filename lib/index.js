...
function CreateApplication(){
  var app = {
    ...
    postRendererCreation: function () {
      ...
      this.agents = [];
      this.agents.push(this.makeAgent('good', r(1,19), r(1,12), 'edgar',
                                      {animated:true, group:true}));
      this.agents.push(this.makeAgent('evil', r(1,19), r(1,12), 'xcom-soldier',
                                      {group:true}));
      this.agents.push(this.makeAgent('good', r(1,19), r(1,12), 'monkey',
                                      {group:true}));
      this.agents.push(this.makeAgent('evil', r(1,19), r(1,12), 'randi',
                                      {group:true}));
    ...
    makeAgent: function(team, gx, gy, spriteHandle, visualOpts) {
      var map = this.map;
