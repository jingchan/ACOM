...
var SensoryComponent = require('./component/sensory');
...
function CreateApplication(){
  var app = {
    ...
    postRendererCreation: function () {
      ...
      var bunny = new Agent('Jing', r(1,18), r(1,12));
    ...
    makeAgent: function(team, gx, gy, spriteHandle, opts) {
      ...
      if (0 <= gx && gx <= map.width && 0 <= gy && gy <= map.width) {
        ...
        agent.addComponent(new SensoryComponent({sightRange: 6}));
        ...
        agent.addComponent(new ActorComponent(acts, {AIType:opts.AIType}));
